...
const initialState = {
  ...
  function rootReducer(state = initialState, {type, payload}){
    switch (type) {
        ...
        case DELETE_FAV:
            const filtered = state.myFavorites.filter((id) => id !== payload) // para eliminar un elemento, se arma un nuevo arreglo filtrando el elemento que se pasa por el payload, generando un nuevo arreglo con todos los elementos menos el del payload
                return{
                    ...state,
